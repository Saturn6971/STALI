    ...
    <div className="min-h-screen bg-[var(--background)] text-[var(--foreground)]">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12">
          <div className="flex items-center justify-between h-14 sm:h-16">
            ...
            <div className="flex items-center space-x-4">
              <Link href="/seller" className="text-gray-300 hover:text-white transition-colors duration-200 font-medium text-sm sm:text-base">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-12 py-6 sm:py-8">
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          {/* Specifications */}
          <div className="bg-[var(--card-bg)] rounded-xl sm:rounded-2xl border border-[var(--card-border)] p-4 sm:p-6">
            <h2 className="text-lg sm:text-xl font-semibold text-white mb-3 sm:mb-4">System Specifications</h2>
