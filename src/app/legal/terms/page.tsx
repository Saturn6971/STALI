    ...
    <div className="min-h-screen bg-[var(--background)] text-[var(--foreground)]">
      <div className="max-w-4xl mx-auto px-6 py-16 space-y-8">
        <div className="space-y-2">
          ...
          <h1 className="text-3xl font-bold text-white">Terms of Service & Liability Disclaimer</h1>
        ...
        <div className="space-y-6 bg-[var(--card-bg)]/80 border border-[var(--card-border)] rounded-2xl p-6">
          <section className="space-y-2">
            <h2 className="text-xl font-semibold text-white">1. Educational Prototype</h2>
            <p className="text-gray-300">
          ...
          <section className="space-y-2">
            <h2 className="text-xl font-semibold text-white">2. No Real Transactions</h2>
            <p className="text-gray-300">
          ...
          <section className="space-y-2">
            <h2 className="text-xl font-semibold text-white">3. No Warranty; Use At Your Own Risk</h2>
            <p className="text-gray-300">
          ...
          <section className="space-y-2">
            <h2 className="text-xl font-semibold text-white">4. Content Accuracy and Moderation</h2>
            <p className="text-gray-300">
          ...
          <section className="space-y-2">
            <h2 className="text-xl font-semibold text-white">6. No Liability for Sales or Damages</h2>
            <p className="text-gray-300">
          ...
          <section className="space-y-2">
            <h2 className="text-xl font-semibold text-white">7. Personal Data</h2>
            <p className="text-gray-300">
