    ...
    <div className="min-h-screen bg-[var(--background)] text-[var(--foreground)]">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 py-12 sm:py-16 space-y-6 sm:space-y-8">
        <div className="space-y-2">
          ...
          <h1 className="text-2xl sm:text-3xl font-bold text-white">Impressum</h1>
        ...
        <div className="space-y-4 sm:space-y-6 bg-[var(--card-bg)]/80 border border-[var(--card-border)] rounded-xl sm:rounded-2xl p-4 sm:p-6">
          <div className="space-y-1">
            <h2 className="text-lg sm:text-xl font-semibold text-white">Project Owner</h2>
          ...
          <div className="space-y-1">
            <h2 className="text-lg sm:text-xl font-semibold text-white">Educational Purpose Only</h2>
            <p className="text-gray-300">
          ...
          <div className="space-y-1">
            <h2 className="text-lg sm:text-xl font-semibold text-white">Content Responsibility</h2>
            <p className="text-gray-300">
          ...
          <div className="space-y-1">
            <h2 className="text-lg sm:text-xl font-semibold text-white">Liability Notice</h2>
            <p className="text-gray-300">
