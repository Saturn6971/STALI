            ...
            <div className="hidden md:flex items-center space-x-6">
              ...
              {user ? (
                <div className="flex items-center space-x-4">
                  ...
                  <Link 
                    href="/saved"
                    className="text-gray-300 hover:text-white transition-colors duration-200 p-2 hover:bg-[var(--card-bg)] rounded-lg"
                  ...
                  <Link 
                    href="/seller"
                    className="bg-[var(--brand)] hover:bg-[var(--brand-light)] text-white px-5 py-2 rounded-lg font-medium transition-all duration-200 hover:scale-105"
                  >
                    Sell
                  </Link>
                </div>
              ...
              <div className="flex flex-col space-y-4">
                ...
                {user ? (
                  <div className="pt-4 space-y-3">
                    <div className="text-gray-300 text-sm py-2 truncate" title={user.user_metadata?.display_name || user.user_metadata?.username || user.email}>
                    ...
                    <Link 
                      href="/saved"
                      className="w-full text-gray-300 hover:text-white transition-colors duration-200 font-medium py-2 flex items-center gap-2"
                    >
